...
void initOptionMap()
{
  ...
  optionMap["--deleglise_rivat3"]          = OPTION_DELEGLISE_RIVAT3;
  optionMap["--deleglise_rivat4"]          = OPTION_DELEGLISE_RIVAT4;
  ...
  optionMap["--deleglise_rivat_parallel4"] = OPTION_DELEGLISE_RIVAT_PARALLEL4;
