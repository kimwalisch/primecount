...
void test()
{
  ...
  try
  {
    ...
    TEST1(pi_deleglise_rivat1,          pi_meissel,    600);
    TEST1(pi_deleglise_rivat2,          pi_meissel,    600);
    TEST2(pi_deleglise_rivat_parallel1, pi_meissel,    1500);

#ifdef HAVE_INT128_T
    TEST2(pi_deleglise_rivat_parallel2, pi_meissel,    1500);
#endif
