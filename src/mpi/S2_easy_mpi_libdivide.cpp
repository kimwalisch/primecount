...
///        and the sparse easy leaves. This is a distributed
///        implementation using MPI (Message Passing Interface) and
///        OpenMP multi-threading.
///
///        This version of S2_easy(x, y) has been optimized using
                    ...
                    int threads)
{
  ...
  int64_t s2_easy = ::S2_easy_mpi((uint64_t) x, y, z, c, primes, threads);
                     ...
                     int threads)
{
  ...
  if (y <= numeric_limits<uint32_t>::max())
  {
    ...
    s2_easy = ::S2_easy_mpi((uint128_t) x, y, z, c, primes, threads);
  }
  else
  {
