...
///        In this implementation the easy leaves have been split up
///        into clustered easy leaves and sparse easy leaves.
///        This implementation is based on the paper: Tomás Oliveira e
///        Silva, Computing pi(x): the combinatorial method, Revista do
///        DETUA, vol. 4, no. 6, March 2006, pp. 759-768.
///
           ...
           vector<int32_t>& mu)
{
  ...
  for (size_t i = 1; i < primes.size(); i++)
  {
    ...
    min_clustered_easy_leaves[i] = pi[min(y, isqrt(x / primes[i]))];
    min_sparse_easy_leaves[i] = pi[min(y, z / prime)];
  }
