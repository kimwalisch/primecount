...
cmake -S . -B build-curr-release  -G "Unix Makefiles" -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=ON
cmake --build build-curr-release -- -j4

# Checkout the previous release tag
git checkout $(git describe --tags --abbrev=0)
cmake -S . -B build-prev-release  -G "Unix Makefiles" -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=ON
