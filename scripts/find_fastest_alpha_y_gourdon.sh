...
do
    ...
    do
        ...
        do
            ...
            do
                seconds=$(get_primecount_seconds "1e$i --gourdon -t$threads --alpha-z=1 --alpha-y=$new_alpha_y")
                echo "1e$i --gourdon --threads=$threads --alpha-z=1 --alpha-y=$new_alpha_y, seconds: $seconds"
