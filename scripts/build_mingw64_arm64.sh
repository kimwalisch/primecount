...
clang++ -c -I../../include -I../../src -I../../lib/primesieve/include \
  ...
  -DENABLE_LIBDIVIDE -DENABLE_MULTIARCH_ARM_SVE -DINIT_LLVM_OPENMP -DHAVE_PUTENV_S -DNDEBUG -D_WIN32_WINNT=0x0A00 \
...
wget https://github.com/kimwalisch/primecount/releases/download/v8.0/primecount-8.0-win-arm64.zip
unzip primecount-8.0-win-arm64.zip -d primecount-$VERSION-win-arm64-tmp
rm primecount-8.0-win-arm64.zip
