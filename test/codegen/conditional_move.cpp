...
///        compiler emits a conditional move instruction instead of a
///        branch when our code uses the CONDITIONAL_MOVE macro.
///        Hence, we check if the assembly code generated by the
///        compiler contains exactly two CMOV* instructions (x86-64). 
///
