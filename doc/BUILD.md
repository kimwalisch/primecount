...
You need to have installed a C++ compiler which supports C++14 (or later) and CMake ≥ 3.9.
...
option(WITH_DIV32           "Use 32-bit division instead of 64-bit division if possible" OFF)
